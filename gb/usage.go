...
Options:
 ...
 -t run tests
 -v verbose
 --create-makefiles generate standard makefiles without building
 --create-workspace create workspace.gb files in all directories
 --dist create distribution
 --gofmt run gofmt on source files in targeted directories
`
