...
func Usage() {
	...
	fmt.Printf(" e exclusive target list (do not build/clean/test/install a target unless its\n")
	fmt.Printf("   directory is listed)\n")
	...
	fmt.Printf("\n")
	//fmt.Printf("--------------------------------------------------------------------------------")
	fmt.Printf(" gb will identify any possible targets existing in subdirectories of the current\n")
	fmt.Printf("working directory, and act on them as appropriate. If a directory list is sup-\n")
	fmt.Printf("plied on the command line, only targets residing in those directories and their\n")
	fmt.Printf("dependencies will be built.\n")
	fmt.Printf("\n")
	fmt.Printf(" If a target's directory contains a directory 'src', that directory will be\n")
	fmt.Printf("recursively searched for any source files, and no additional targets will be\n")
	fmt.Printf("created for directories found within the src directory.\n")
	fmt.Printf("\n")
	fmt.Printf(" By default, the target built from a particular directory is the same as the\n")
	fmt.Printf("relative path to that directory. By providing a file 'target.gb' in the direct-\n")
	fmt.Printf("ory, one can change the target. This affects all subdirectories, as well. If a\n")
	fmt.Printf("directory 'a' has a target.gb file containing the line 'a.googlecode.com/hg/a',\n")
	fmt.Printf("then the directory 'a/b' will have the target 'a.googlecode.com/hg/a/b'.\n")
	fmt.Printf("\n")
	fmt.Printf(" In addition to providing target.gb, the programmer can also put a comment in\n")
	fmt.Printf("one of the package's source files, before the package statement. The comment is\n")
	fmt.Printf("of the form '//target:<name>'. It has the same effect as providing target.gb. If\n")
	fmt.Printf("a target.gb file exists, it will be used instead of the comment.\n")
	fmt.Printf("\n")
